...
class ProductManager {
    ...
    async loadProducts() {
        try {
            ...
            return JSON.parse(data) || []; // Devolvemos los productos leídos o un array vacío si no hay datos
        } catch (error) {
...
//Entramos a la clase productManager e imporimimos IDs 1,2,3 
productManager.getProductById(1)

//Entramos a la clase productManager y borramos el item con ID 2
